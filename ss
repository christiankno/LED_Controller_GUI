...
DDEESSCCRRIIPPTTIIOONN
       Incorporates changes from a remote repository into the current branch. In its default mode, ggiitt ppuullll is
       shorthand for ggiitt ffeettcchh followed by ggiitt mmeerrggee FFEETTCCHH__HHEEAADD.

       More precisely, _g_i_t _p_u_l_l runs _g_i_t _f_e_t_c_h with the given parameters and calls _g_i_t _m_e_r_g_e to merge the retrieved
       branch heads into the current branch. With ----rreebbaassee, it runs _g_i_t _r_e_b_a_s_e instead of _g_i_t _m_e_r_g_e.

       <repository> should be the name of a remote repository as passed to ggiitt--ffeettcchh(1). <refspec> can name an
       ...
       current branch as set by ggiitt--bbrraanncchh(1) ----ttrraacckk.
       ...
       Then "ggiitt ppuullll" will fetch and replay the changes from the remote mmaasstteerr branch since it diverged from the
       local mmaasstteerr (i.e., EE) until its current commit (CC) on top of mmaasstteerr and record the result in a new commit
       ...
       In Git 1.7.0 or later, to cancel a conflicting merge, use ggiitt rreesseett ----mmeerrggee. WWaarrnniinngg: In older versions of
       Git, running _g_i_t _p_u_l_l with uncommitted changes is discouraged: while possible, it leaves you in a state that
       may be hard to back out of in the case of a conflict.

       If any of the remote changes overlap with local uncommitted changes, the merge will be automatically canceled
       and the work tree untouched. It is generally best to get any local changes in working order before pulling or
       stash them away with ggiitt--ssttaasshh(1).
...
OOPPTTIIOONNSS
       ...
       --[no-]recurse-submodules[=yes|on-demand|no]
           ...
           ggiitt--ccoonnffiigg(1) and ggiittmmoodduulleess(5)).
   ...
   OOppttiioonnss rreellaatteedd ttoo mmeerrggiinngg
       ...
       --edit, -e, --no-edit
           ...
           message, so that the user can explain and justify the merge. The ----nnoo--eeddiitt option can be used to accept
           the auto-generated message (this is generally discouraged).

           Older scripts may depend on the historical behaviour of not allowing the user to edit the merge log
           message. They will see an editor opened when they run ggiitt mmeerrggee. To make it easier to adjust such scripts
           to the updated behaviour, the environment variable GGIITT__MMEERRGGEE__AAUUTTOOEEDDIITT can be set to nnoo at the beginning of
           them.
       ...
       --no-ff
           ...
           merging an annotated (and possibly signed) tag that is not stored in its natural place in _r_e_f_s_/_t_a_g_s_/
           hierarchy.

       --ff-only
           Refuse to merge and exit with a non-zero status unless the current HHEEAADD is already up to date or the merge
           can be resolved as a fast-forward.

       -S[<keyid>], --gpg-sign[=<keyid>]
           GPG-sign the resulting merge commit. The kkeeyyiidd argument is optional and defaults to the committer
       ...
       --log[=<n>], --no-log
           ...
           commits that are being merged. See also ggiitt--ffmmtt--mmeerrggee--mmssgg(1).
       ...
       --signoff, --no-signoff
           ...
           the same license and agrees to a Developer Certificate of Origin (see hhttttpp::////ddeevveellooppeerrcceerrttiiffiiccaattee..oorrgg// for
           more information).
       ...
       --squash, --no-squash
           ...
           but do not actually make a commit, move the HHEEAADD, or record $$GGIITT__DDIIRR//MMEERRGGEE__HHEEAADD (to cause the next ggiitt
           ccoommmmiitt command to create a merge commit). This allows you to create a single commit on top of the current
       ...
       -s <strategy>, --strategy=<strategy>
           ...
           tried. If there is no --ss option, a built-in list of strategies is used instead (_g_i_t _m_e_r_g_e_-_r_e_c_u_r_s_i_v_e when
           merging a single head, _g_i_t _m_e_r_g_e_-_o_c_t_o_p_u_s otherwise).
       ...
       --allow-unrelated-histories
           By default, ggiitt mmeerrggee command refuses to merge histories that do not share a common ancestor. This option
       ...
       -r, --rebase[=false|true|merges|preserve|interactive]
           ...
           When set to mmeerrggeess, rebase using ggiitt rreebbaassee ----rreebbaassee--mmeerrggeess so that the local merge commits are included
           in the rebase (see ggiitt--rreebbaassee(1) for details).

           When set to preserve, rebase with the ----pprreesseerrvvee--mmeerrggeess option passed to ggiitt rreebbaassee so that locally
           ...
           See ppuullll..rreebbaassee, bbrraanncchh..<<nnaammee>>..rreebbaassee and bbrraanncchh..aauuttooSSeettuuppRReebbaassee in ggiitt--ccoonnffiigg(1) if you want to make ggiitt
           ppuullll always use ----rreebbaassee instead of merging.

               NNoottee
               This is a potentially _d_a_n_g_e_r_o_u_s mode of operation. It rewrites history, which does not bode well when
               you published that history already. Do nnoott use this option unless you have read ggiitt--rreebbaassee(1)
               carefully.
       ...
       --autostash, --no-autostash
           Before starting rebase, stash local modifications away (see ggiitt--ssttaasshh(1)) if needed, and apply the stash
           entry when done.  ----nnoo--aauuttoossttaasshh is useful to override the rreebbaassee..aauuttooSSttaasshh configuration variable (see
   ...
   OOppttiioonnss rreellaatteedd ttoo ffeettcchhiinngg
       ...
       -a, --append
           Append ref names and object names of fetched refs to the existing contents of ..ggiitt//FFEETTCCHH__HHEEAADD. Without
           this option old data in ..ggiitt//FFEETTCCHH__HHEEAADD will be overwritten.

       --depth=<depth>
           Limit fetching to the specified number of commits from the tip of each remote branch history. If fetching
           to a _s_h_a_l_l_o_w repository created by ggiitt cclloonnee with ----ddeepptthh==<<ddeepptthh>> option (see ggiitt--cclloonnee(1)), deepen or
       ...
       --update-shallow
           By default when fetching from a shallow repository, ggiitt ffeettcchh refuses refs that require updating
           .git/shallow. This option updates .git/shallow and accept such refs.

       --negotiation-tip=<commit|glob>
           By default, Git will report, to the server, commits reachable from all local refs to find common commits
           in an attempt to reduce the size of the to-be-received packfile. If specified, Git will only report
           commits reachable from the given tips. This is useful to speed up fetches when the user knows which local
           ref is likely to have commits in common with the upstream ref being fetched.

           This option may be specified more than once; if so, Git will report commits reachable from any of the
           given commits.

           The argument to this option may be a glob on ref names, a ref, or the (possibly abbreviated) SHA-1 of a
           commit. Specifying a glob is equivalent to specifying this option multiple times, one for each matching
           ref name.
       ...
       -f, --force
           When _g_i_t _f_e_t_c_h is used with <<ssrrcc>>::<<ddsstt>> refspec it may refuse to update the local branch as discussed in
           the <<rreeffssppeecc>> part of the ggiitt--ffeettcchh(1) documentation. This option overrides that check.
       ...
       --no-tags
           ...
           be specified with the remote.<name>.tagOpt setting. See ggiitt--ccoonnffiigg(1).

       -u, --update-head-ok
           By default _g_i_t _f_e_t_c_h refuses to update the head which corresponds to the current branch. This flag
           disables the check. This is purely for the internal use for _g_i_t _p_u_l_l to communicate with _g_i_t _f_e_t_c_h, and
           unless you are implementing your own Porcelain you are not supposed to use it.

       --upload-pack <upload-pack>
           When given, and the repository to fetch from is handled by _g_i_t _f_e_t_c_h_-_p_a_c_k, ----eexxeecc==<<uuppllooaadd--ppaacckk>> is passed
       ...
       -o <option>, --server-option=<option>
           ...
           not contain a NUL or LF character. When multiple ----sseerrvveerr--ooppttiioonn==<<ooppttiioonn>> are given, they are all sent to
       ...
       <refspec>
           ...
           line, the refs to fetch are read from rreemmoottee..<<rreeppoossiittoorryy>>..ffeettcchh variables instead (see ggiitt--ffeettcchh(1)).
           ...
           ttaagg <<ttaagg>> means the same as rreeffss//ttaaggss//<<ttaagg>>::rreeffss//ttaaggss//<<ttaagg>>; it requests fetching everything up to the
           given tag.
           ...
           Whether that update is allowed without ----ffoorrccee depends on the ref namespace it’s being fetched to, the
           type of object being fetched, and whether the update is considered to be a fast-forward. Generally, the
           same rules apply for fetching as when pushing, see the <<rreeffssppeecc>>......  section of ggiitt--ppuusshh(1) for what those
           are. Exceptions to those rules particular to _g_i_t _f_e_t_c_h are noted below.

           Until Git version 2.20, and unlike when pushing with ggiitt--ppuusshh(1), any updates to rreeffss//ttaaggss//** would be
           accepted without ++ in the refspec (or ----ffoorrccee). When fetching, we promiscuously considered all tag updates
           from a remote to be forced fetches. Since Git version 2.20, fetching to update rreeffss//ttaaggss//** works the same
           way as when pushing. I.e. any updates will be rejected without ++ in the refspec (or ----ffoorrccee).

           Unlike when pushing with ggiitt--ppuusshh(1), any updates outside of rreeffss//{{ttaaggss,,hheeaaddss}}//** will be accepted without
           ++ in the refspec (or ----ffoorrccee), whether that’s swapping e.g. a tree object for a blob, or a commit for
           another commit that’s doesn’t have the previous commit as an ancestor etc.

           Unlike when pushing with ggiitt--ppuusshh(1), there is no configuration which’ll amend these rules, and nothing
           like a pprree--ffeettcchh hook analogous to the pprree--rreecceeiivvee hook.

           As with pushing with ggiitt--ppuusshh(1), all of the rules described above about what’s not allowed as an update
           can be overridden by adding an the optional leading ++ to a refspec (or using ----ffoorrccee command line option).
           The only exception to this is that no amount of forcing will make the rreeffss//hheeaaddss//** namespace accept a
           non-commit object.
               ...
               NNoottee
               There is a difference between listing multiple <refspec> directly on _g_i_t _p_u_l_l command line and having
               multiple rreemmoottee..<<rreeppoossiittoorryy>>..ffeettcchh entries in your configuration for a <repository> and running a _g_i_t
               _p_u_l_l command without any explicit <refspec> parameters. <refspec>s listed explicitly on the command
               line are always merged into the current branch after fetching. In other words, if you list more than
               one remote ref, _g_i_t _p_u_l_l will create an Octopus merge. On the other hand, if you do not list any
               explicit <refspec> parameter on the command line, _g_i_t _p_u_l_l will fetch all the <refspec>s it finds in
               the rreemmoottee..<<rreeppoossiittoorryy>>..ffeettcchh configuration and merge only the first <refspec> found into the current
...
MMEERRGGEE SSTTRRAATTEEGGIIEESS
       The merge mechanism (ggiitt mmeerrggee and ggiitt ppuullll commands) allows the backend _m_e_r_g_e _s_t_r_a_t_e_g_i_e_s to be chosen with --ss
       option. Some strategies can also take their own options, which can be passed by giving --XX<<ooppttiioonn>> arguments to
       ggiitt mmeerrggee and/or ggiitt ppuullll.
       ...
       recursive
           ...
           ours
               This option forces conflicting hunks to be auto-resolved cleanly by favoring _o_u_r version. Changes from
               ...
               This should not be confused with the _o_u_r_s merge strategy, which does not even look at what the other
               tree contains at all. It discards everything the other tree did, declaring _o_u_r history contains all
               that happened in it.

           theirs
               This is the opposite of _o_u_r_s; note that, unlike _o_u_r_s, there is no _t_h_e_i_r_s merge strategy to confuse
               this merge option with.

           patience
               With this option, _m_e_r_g_e_-_r_e_c_u_r_s_i_v_e spends a little extra time to avoid mismerges that sometimes occur
               due to unimportant matching lines (e.g., braces from distinct functions). Use this when the branches
               to be merged have diverged wildly. See also ggiitt--ddiiffff(1) ----ppaattiieennccee.

           diff-algorithm=[patience|minimal|histogram|myers]
               Tells _m_e_r_g_e_-_r_e_c_u_r_s_i_v_e to use a different diff algorithm, which can help avoid mismerges that occur due
               to unimportant matching lines (such as braces from distinct functions). See also ggiitt--ddiiffff(1)
               ----ddiiffff--aallggoorriitthhmm.

           ignore-space-change, ignore-all-space, ignore-space-at-eol, ignore-cr-at-eol
               Treats lines with the indicated type of whitespace change as unchanged for the sake of a three-way
               merge. Whitespace changes mixed with other changes to a line are not ignored. See also ggiitt--ddiiffff(1) --bb,
               --ww, ----iiggnnoorree--ssppaaccee--aatt--eeooll, and ----iiggnnoorree--ccrr--aatt--eeooll.

               •   If _t_h_e_i_r version only introduces whitespace changes to a line, _o_u_r version is used;

               •   If _o_u_r version introduces whitespace changes but _t_h_e_i_r version includes a substantial change,
                   _t_h_e_i_r version is used;
           ...
           no-renames
               Turn off rename detection. This overrides the mmeerrggee..rreennaammeess configuration variable. See also ggiitt--
               ddiiffff(1) ----nnoo--rreennaammeess.

           find-renames[=<n>]
               Turn on rename detection, optionally setting the similarity threshold. This is the default. This
               overrides the _m_e_r_g_e_._r_e_n_a_m_e_s configuration variable. See also ggiitt--ddiiffff(1) ----ffiinndd--rreennaammeess.

           rename-threshold=<n>
               Deprecated synonym for ffiinndd--rreennaammeess==<<nn>>.

           subtree[=<path>]
               This option is a more advanced form of _s_u_b_t_r_e_e strategy, where the strategy makes a guess on how two
       ...
       ours
           ...
           _r_e_c_u_r_s_i_v_e merge strategy.
...
DDEEFFAAUULLTT BBEEHHAAVVIIOOUURR
       Often people use ggiitt ppuullll without giving any parameter. Traditionally, this has been equivalent to saying ggiitt
       ppuullll oorriiggiinn. However, when configuration bbrraanncchh..<<nnaammee>>..rreemmoottee is present while on branch <<nnaammee>>, that value is
       used instead of oorriiggiinn.

       In order to determine what URL to use to fetch from, the value of the configuration rreemmoottee..<<oorriiggiinn>>..uurrll is
       consulted and if there is not any such variable, the value on the UURRLL:: line in $$GGIITT__DDIIRR//rreemmootteess//<<oorriiggiinn>> is
       used.
       ...
       variable rreemmoottee..<<oorriiggiinn>>..ffeettcchh are consulted, and if there aren’t any, $$GGIITT__DDIIRR//rreemmootteess//<<oorriiggiinn>> is consulted
       and its PPuullll:: lines are used. In addition to the refspec formats described in the OPTIONS section, you can
       ...
       remote-tracking branches in rreeffss//rreemmootteess//oorriiggiinn// hierarchy under the same name.
       ...
       When no refspec was given on the command line, then ggiitt ppuullll uses the refspec from the configuration or
       $$GGIITT__DDIIRR//rreemmootteess//<<oorriiggiinn>>. In such cases, the following rules apply:

        1. If bbrraanncchh..<<nnaammee>>..mmeerrggee configuration for the current branch <<nnaammee>> exists, that is the name of the branch
...
EEXXAAMMPPLLEESS
       •   Update the remote-tracking branches for the repository you cloned from, then merge one of them into your
           ...
           branch.<name>.remote and branch.<name>.merge options; see ggiitt--ccoonnffiigg(1) for details.

       •   Merge into the current branch the remote branch nneexxtt:

               $ git pull origin next

           This leaves a copy of nneexxtt temporarily in FETCH_HEAD, but does not update any remote-tracking branches.
           Using remote-tracking branches, the same can be done by invoking fetch and merge:

               $ git fetch origin
               $ git merge origin/next

       If you tried a pull which resulted in complex conflicts and would want to start over, you can recover with _g_i_t
       _r_e_s_e_t.
...
Git 2.20.1                                            04/20/2020                                          GIT-PULL(1)
